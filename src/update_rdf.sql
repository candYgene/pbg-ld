...
--
-- Rename chromosome URIs in SGN RDF graphs.
--
-- e.g., http://.../genome/Solanum_lycopersicum/chromosome/SL2.50ch01
-- to:  http://.../genome/Solanum_lycopersicum/chromosome/1
--
-- e.g., http://.../genome/Solanum_pennellii/chromosome/Spenn-ch01
-- to:  http://.../genome/Solanum_pennellii/chromosome/1
--
-- e.g., http://.../genome/Solanum_tuberosum/chromosome/ST4.03ch01
-- to: http://.../genome/Solanum_tuberosum/chromosome/1
--

SPARQL
PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#>
PREFIX Chromosome: <http://purl.obolibrary.org/obo/SO_0000340>
WITH <$u{SGN-SL_G_URI}>
DELETE { ?chr a Chromosome: }
INSERT { ?new_chr a Chromosome: }
WHERE {
   ?chr a Chromosome: .
   BIND(uri(replace(str(?chr), '(chr.+/).+?0?([0-9]+)$', '$1$2')) AS ?new_chr) .
} ;
